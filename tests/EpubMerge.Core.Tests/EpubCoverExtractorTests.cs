...
public sealed class EpubCoverExtractorTests : IDisposable
{
    ...
    public EpubCoverExtractorTests() => Directory.CreateDirectory(_directory);
    ...
    private static void Write(ZipArchive archive, string name, string value) => WriteBytes(archive, name, Encoding.UTF8.GetBytes(value));
